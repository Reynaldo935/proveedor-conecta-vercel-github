      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 pt-6 border-t">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-6">
            {[
              { name: "Reynaldo", role: "Full-Stack Developer", photo: "/Reynaldo.jpg" },
              { name: "Apolonio", role: "Frontend Developer", photo: "/Apolonio.jpg" },
              { name: "Sarahí", role: "Graphic Designer", photo: "/Sarahi.jpg" },
              { name: "Pedro", role: "Communicator", photo: "/Pedro.jpg" },
              { name: "Mychael", role: "Marketing", photo: "/Mychael.jpg" },
            ].map((member) => (
